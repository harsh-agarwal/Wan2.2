...
# Parse arguments
MODE=${1:-"mini"}  # mini, full, or train
...
case $MODE in
    mini)
        ...
        python3 scripts/download_ditto_style.py --mini --mini_pairs 30 --output_dir ./data/ditto_mini
        
        # Preprocess
        echo ""
        echo "Step 2/4: Preprocessing data..."
        python3 scripts/preprocess_ditto.py \
            --data_dir ./data/ditto_mini \
...
data:
  data_dir: "./data/ditto_mini"
  train_metadata: "./data/processed/train_metadata.json"
  val_metadata: "./data/processed/val_metadata.json"
...
EOF
    ...
    full)
        ...
        python3 scripts/download_ditto_style.py --output_dir ./data/ditto
    ...
    *)
        ...
        echo ""
        echo "Modes:"
        echo "  mini  - Quick test with small dataset (~2 hours)"
        echo "  full  - Complete training pipeline (~60 hours)"
        echo "  train - Resume or start training (assumes data is ready)"
        echo ""
        echo "Examples:"
        echo "  ./scripts/quick_start.sh mini   # Quick test"
